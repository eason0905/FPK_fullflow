...
DATASET_ROOT = PROJECT_ROOT / "real_image_process" / "FPK_PJ_fullflow" / "assets" / "datasets" / "dataset_full_v4"
OUTPUT_ROOT = SCRIPT_DIR / "yolo_dataset"
...
def build_dataset(
    ...
    for annotation_path in annotation_paths:
        ...
        label_dst = label_dst_dir / f"{image_path.stem}.txt"
    ...
    legacy_dataset_yaml = SCRIPT_DIR / "dataset.yaml"
    _write_dataset_yaml(legacy_dataset_yaml, output_root)

    summary = {
        "input_root": str(input_root.resolve()),
        "output_root": str(output_root.resolve()),
        "dataset_yaml": str(dataset_yaml.resolve()),
        "legacy_dataset_yaml": str(legacy_dataset_yaml.resolve()),
